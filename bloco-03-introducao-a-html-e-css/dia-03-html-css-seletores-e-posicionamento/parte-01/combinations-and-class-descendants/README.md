...
__Dica 1:__ Utilize o seletor :hover para controlar o passar do mouse.

__Dica 2:__ Sugestão de cores padrão. StackOverflow (laranja), W3Schools (verde), MDN (preta), DevDocs (amarela), Trybe (verde).
